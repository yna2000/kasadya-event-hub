  ...
  return (
    <div className="space-y-4">
      ...
      <RadioGroup value={selectedMethod} onValueChange={onMethodChange} className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className={`border-2 cursor-pointer ${selectedMethod === 'gcash' ? 'border-blue-500' : 'border-gray-200'}`}>
        ...
        <Card className={`border-2 cursor-pointer ${selectedMethod === 'maya' ? 'border-blue-500' : 'border-gray-200'}`}>
          <CardContent className="p-4">
            <RadioGroupItem value="maya" id="maya" className="sr-only" />
            <Label htmlFor="maya" className="flex items-center gap-2 cursor-pointer">
              <div className={`p-2 rounded-full ${selectedMethod === 'maya' ? 'bg-blue-100' : 'bg-gray-100'}`}>
        ...
        <Card className={`border-2 cursor-pointer ${selectedMethod === 'bank' ? 'border-blue-500' : 'border-gray-200'}`}>
          <CardContent className="p-4">
        ...
        <Card className={`border-2 cursor-pointer ${selectedMethod === 'cash' ? 'border-blue-500' : 'border-gray-200'}`}>
          <CardContent className="p-4">
